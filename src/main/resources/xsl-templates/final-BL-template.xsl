	...
	<xsl:template match="dummyData">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<fo:layout-master-set>
			    ...
			    <!-- <fo:simple-page-master master-name="simpleA4" page-height="20cm" page-width="10.5cm" margin-left="0.2cm"
					margin-right="0.2cm">
			        <fo:region-body margin-top="0.2cm" column-count="3"/>
			    </fo:simple-page-master> -->
			</fo:layout-master-set>
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block font-family="Arial" font-weight="normal">
							...
							<fo:table-body height="6cm">
									<fo:table-row height="0.7cm">  <!-- border="solid 0.1mm black" -->
										...
										<fo:table-cell text-align="right">
											<fo:block margin-top="8pt" font-family="Arial" font-weight="bold" font-size="10pt">
												BILL OF LADING
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<fo:table-row height="0.6cm">
										...
										<fo:table-cell text-align="center">
											<fo:block margin-top="8pt" font-size="10px" font-weight="bold">
						...
						<fo:table margin-top="6pt">
							...
							<fo:table-body height="10cm">
								...
								<fo:table-row height="0.5cm">
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="2" number-rows-spanned="3">
								...
								<!-- 2 -->
								<fo:table-row height="0.5cm">
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="2" number-rows-spanned="2">
										<fo:block font-family="Arial" font-size="7.7pt">
											CONSIGNED TO
											<fo:block font-family="Arial" font-size="10pt" font-weight="bold">
									...
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="2">
										<fo:block font-family="Arial" font-size="7.7pt">
											FORWARDING AGENT
											<fo:block font-family="Arial" font-size="10pt" font-weight="bold">
								...
								<!-- 4 -->
								<fo:table-row height="0.5cm">
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="2" height="1cm">
										<fo:block font-family="Arial" font-size="7.7pt">
						...
						<fo:table>
							...
							<fo:table-column column-number="4" column-width="2.5cm" border="solid 0.1mm black" />
							<fo:table-column column-number="5" column-width="2.5cm" border="solid 0.1mm black" />
							<fo:table-column column-number="6" column-width="2.5cm" border="solid 0.1mm black" />
							<fo:table-column column-number="7" column-width="2.5cm" border="solid 0.1mm black" />
							<fo:table-column column-number="8" column-width="2.5cm" border="solid 0.1mm black" />
							<fo:table-header border="solid 0.1mm black">
								<fo:table-row height="0.7cm">
									...
									<fo:table-cell text-align="center" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="3">
										<fo:block font-family="Arial" font-size="7.7pt">
							...
							<fo:table-footer>
								<fo:table-row height="0.3cm">
									...
									<fo:table-cell text-align="right" padding-end="4pt" padding-before="1pt" padding-top="12pt" padding-bottom="2pt" number-columns-spanned="3">
										<fo:block font-family="Arial" font-size="10pt" font-weight="bold">
											Total
										</fo:block>
									</fo:table-cell>
											...
											<fo:block font-family="Arial" font-size="10pt" font-weight="bold" padding-top="3pt" padding-bottom="1pt">
												...
												<xsl:choose>
							                        <xsl:when test="nbRows != ''">
							                        	<fo:table-cell text-align="justify" padding-start="7pt" padding-end="7pt" number-columns-spanned="3">
						...
						<fo:table page-break-after="always">
							...
							<fo:table-body>
								...
								<fo:table-row height="0.3cm" border="solid 0.1mm black">
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="4">
										<fo:block font-family="Arial" font-size="7.7pt">
											* APPLICABLE ONLY WHEN DOCUMENT USED AS COMBINED TRANSPORT BILL OF LADING
										</fo:block>
									</fo:table-cell>
									<fo:table-cell number-columns-spanned="4" padding-top="1pt" padding-start="2pt" padding-end="12pt" text-align="left">
										<fo:block font-family="Arial" font-size="7.7pt">
								...
								<!-- 4 -->
								<fo:table-row height="0.1cm">
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" padding-end="2pt" number-columns-spanned="2" number-rows-spanned="2">
										<fo:block font-family="Arial" font-size="7.7pt" space-after="1mm">
										...
										<fo:block font-family="Arial" font-size="7.7pt" space-before="1mm">
									...
									<fo:table-cell text-align="center" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="6">
										<fo:block font-family="Arial" font-size="7.7pt">
											FREIGHT AND CHARGES
										</fo:block>
									</fo:table-cell>
								...
								<fo:table-row height="2cm">
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="2pt" padding-before="1pt" number-columns-spanned="6">
										<fo:block font-family="Arial" font-size="7.7pt">
								...
								<fo:table-row height="0.5cm">
									...
									<fo:table-cell text-align="left" border="solid 0.1mm black" padding-start="20pt" padding-before="1pt" number-columns-spanned="6">
										<fo:block font-family="Arial" font-size="7.7pt">
											TOTAL PREPAID 
											<fo:block font-family="Arial" font-size="10pt" font-weight="bold">
...
8. (Liberties) (A) In any situation whatsoever whether or not existing or anticipated before commencement of or during the transport, which in the judgement of the Ocean Carrier (including for the purpose of this Article the Master and any person charged with the transport or safekeeping of the Goods) has given or is likely to give rise to danger, injury, loss, delay, or disadvantage of whatsoever nature to the Vessel, the Ocean Carrier, a vehicle, any person, the Goods or any property, or has rendered or is likely to render it in any way unsafe, impracticable, unlawful, or against the interest of the Ocean Carrier or the Merchant to commence or continue the transport or to discharge 
									...
									<fo:table-cell text-align="justify" padding-start="6pt" padding-end="6pt">
										<fo:block margin-right="-3pt" line-height="2.4mm" font-family="Times New Roman" font-size="8pt">
...
29. (Carriage of Metal Products, Lumber, Cotton)  (A) The term "apparent good order and condition" when used in this Bill of Lading does not mean: (1) with reference to iron, steel, or metal products, that the Goods when received were free from visible rust or moisture. (2) with reference to lumber, timber, plywood, or other wood products, that the Goods when received were free from visible stains, discoloration, moisture, shakes, holes, chaffed, breakage or splitting.  If the Merchant so requests a substitute bill of lading will be issued setting forth any notations 
										</fo:block>
									</fo:table-cell>
									<fo:table-cell text-align="justify" padding-start="6pt" padding-end="6pt">
										<fo:block padding-before="1.35pt" margin-left="-3pt" line-height="2.4mm" font-family="Times New Roman" font-size="8pt">
											as to the foregoing that may appear on the mate's or tally clerk's receipts or similar document.  (B) Description of the condition of cotton cargo does not relate to the sufficiency or not or condition of the covering nor to any damage, resulting therefrom.  Ocean Carrier shall not be responsible for any such damage.
30. (Grain)  Discharge of grain received by the Ocean Carrier in bulk may be in port, on barges, and or lighters, or elsewhere, using or not using elevators, and such discharge shall constitute a sufficient delivery by the Carrier.  Thereafter said grain shall be at the risk and expense of the Merchant.
31. (Intermodal Transportation)  (A) This Bill of Lading may be issued for Intermodal Transportation in any country.  When so issued as between the Merchant and an Inland Carrier custody and carriage of the Goods by the Inland Carrier are subject to the relevant laws, regulations, tariffs and bill of lading are available from the Ocean or Inland Carrier upon request.  (B) Claims by the Merchant against an Inland Carrier for loss or damage shall be given and suit commenced as provided in the Inland Carrier's applicable bill of lading
32. (Ocean Carrier's Tariff)  This Bill of Lading is subject to the Ocean Carrier's application tariff.  Copies of the applicable tariff are obtainable from the Ocean Carrier upon request.
