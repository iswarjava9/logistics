...
@NamedQueries({@NamedQuery(name="ContainerType.findAll", query="SELECT c FROM ContainerType c"),
	@NamedQuery(name = "ContainerType.findByType", query = "SELECT c FROM ContainerType c where c.type like :type")})
